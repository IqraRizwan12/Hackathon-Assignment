    ...
    <div style={{border:'1px solid black',backgroundColor:'white',width:'70%',margin:'auto',height:'550px',borderRadius:'10px',padding:'10px',marginTop:'10px'}}>
      ...
      {room ? (
        <div>
          ...
          <form>
            <input  
             style={{border:'1px solid black',borderRadius:'10px',padding:'5px',margin:'10px',width:'250px'}}
              type='text'
              placeholder='Type your message here'
              value={newMessages}
              onChange={(e) => setNewMessages(e.target.value)}
            />
            <button style={{backgroundColor:'green',color:'black',padding:'10px',margin:'10px',borderRadius:'10px',width:'100px'}} onClick={handleMessages} type='submit'>
              Send
            </button>
          </form>
          </center>
        ...
        <div>
          ...
          <button style={{backgroundColor:'green',color:'black',padding:'10px',margin:'10px',borderRadius:'10px'}} onClick={() => setRoom(roomInputRef.current.value)}>Enter Chat</button>
          </center>
        </div>
      )}
